...
class TIntroductionHardwareFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_t_introduction_in_hardware, container, false)

        val cardView: View = view.findViewById(R.id.firstCardView)


//        cardView.setOnClickListener {
//            // Create and show the dialog fragment
//            val dialogFragment = LogoutDialogFragment.newInstance()
//            dialogFragment.setAnchorView(cardView) // Set the anchor view
